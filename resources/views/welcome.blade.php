...
<header class="header header-inverse h-fullscreen pb-80" data-parallax="{{ asset('assets/img/bg-man.jpg ') }}" data-overlay="8">
    ...
    <div class="row h-full">
        ...
        <br>
        <p class="lead text-white fs-20 hidden-sm-down"><span class="fw-400">Happycasts</span> is an awesome web development learning<br>subscription based SaaS  application powered with Vuejs and Laravel.</p>
