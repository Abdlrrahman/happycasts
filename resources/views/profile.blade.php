                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8">
                                <div class="card-block">
                                    ...
                                    <a class="fw-600 fs-12"
                                        href="{{ route('series', $s->slug) }}">Read more <i
                                ...
                                <div class="tab-pane" id="settings-2">
                                    <div class="row">
                                        <h2 class="text-center">
                                            Your current card: <span
                                                class="badge badge-sm badge-primary">{{ auth()->user()->card_brand }}:{{ auth()->user()->card_last_four }}</span>
                                        </h2>
